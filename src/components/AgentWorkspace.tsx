      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <svg onMouseEnter={() => setExpanded(true)} className={`w-4 h-4 ${isPaused ? 'text-gray-400' : 'text-gray-500'} transition-transform ${expanded ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
