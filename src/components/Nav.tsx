        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          {user ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/auth/register"
                className="text-sm px-4 py-1.5 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-white transition-colors"
              >
                Get started
              </Link>
            </div>
            ...
            {user ? (
              ...
              <div className="space-y-2">
                ...
                <Link
                  href="/auth/register"
                  onClick={() => setMobileOpen(false)}
                  className="block text-sm px-4 py-1.5 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-white transition-colors text-center"
                >
                  Get started
                </Link>
              </div>
