    ...
    <div className="flex flex-col">
      ...
      <section className="relative pt-24 sm:pt-32 pb-20 sm:pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 text-sm text-gray-600 dark:text-gray-400 mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-gray-900 dark:text-gray-100 mb-6 leading-[1.08]">
            Software that
            <br />
            grows&nbsp;itself.
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="px-6 py-3 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors text-center"
            >
              Explore projects
            </Link>
            <a
              ...
              className="px-6 py-3 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors text-center"
            >
              View on GitHub
            </a>
          </div>
      ...
      {!loading && projects.length > 0 && (
        <section className="py-8 px-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 text-center">
              <div>
                <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{projects.length}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Live projects</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{totalInProgress}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Building now</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{totalQueued}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Ideas queued</div>
              </div>
              <div>
                <div className="text-2xl font-semibold text-gray-900 dark:text-gray-100 tabular-nums">{totalCompleted}</div>
      ...
      <section className="py-16 sm:py-20 px-6 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-10">
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-1">Live projects</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
            <div className="relative">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Pick a project</h3>
            ...
            <div className="relative">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Share an idea</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            ...
            <div className="relative">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Watch it grow</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Bring your own key</h3>
            ...
            <div className="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Priority queue</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Shared knowledge</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
      ...
      <section className="py-20 sm:py-24 px-6 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="inline-block px-8 py-3.5 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
            >
              Explore projects
            </Link>
            <Link
              href="/pricing"
              className="inline-block px-8 py-3.5 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
            >
              View pricing
            </Link>
          </div>
