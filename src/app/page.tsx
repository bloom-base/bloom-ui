  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative pt-24 sm:pt-32 pb-20 sm:pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-violet-50/50 via-white to-white dark:from-violet-950/30 dark:via-gray-900 dark:to-gray-900 pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 text-sm text-gray-600 dark:text-gray-300 mb-8">
      ...
      {!loading && projects.length > 0 && (
        <section className="py-8 px-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
          ...
          {loading ? (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="h-44 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 animate-pulse"
                />
              ))}
            </div>
          ) : fetchError ? (
            <div className="text-center py-16 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
              ...
              <button
                ...
                className="text-sm text-gray-900 dark:text-white underline underline-offset-2 hover:text-gray-600 dark:hover:text-gray-300"
              >
                Try again
              </button>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            <div className="p-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50">
              <div className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mb-3">
