  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative pt-24 sm:pt-32 pb-20 sm:pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-violet-50/50 dark:from-violet-950/30 via-white dark:via-gray-950 to-white dark:to-gray-950 pointer-events-none" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-r from-violet-100/30 dark:from-violet-900/20 via-violet-200/20 dark:via-violet-800/10 to-violet-100/30 dark:to-violet-900/20 rounded-full blur-3xl pointer-events-none" />
          ...
          {loading ? (
            ...
            <div className="text-center py-16 border border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
              ...
              <button
                ...
                className="text-sm text-gray-900 dark:text-gray-100 underline underline-offset-2 hover:text-gray-600 dark:hover:text-gray-400"
              >
                Try again
              </button>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
            <div className="relative">
              <div className="text-xs font-mono text-gray-400 dark:text-gray-600 mb-3">01</div>
            ...
            <div className="relative">
              <div className="text-xs font-mono text-gray-400 dark:text-gray-600 mb-3">02</div>
            ...
            <div className="relative">
              <div className="text-xs font-mono text-gray-400 dark:text-gray-600 mb-3">03</div>
