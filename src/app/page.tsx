  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative pt-24 sm:pt-32 pb-20 sm:pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-violet-50/50 via-white to-white dark:from-violet-950/30 dark:via-gray-950 dark:to-gray-950 pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="px-6 py-3 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium hover:bg-gray-800 dark:hover:bg-white transition-colors text-center"
            >
              Explore projects
            </Link>
            <a
      ...
      <section className="py-20 sm:py-24 px-6 border-t border-gray-100 dark:border-gray-800">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/explore"
              className="inline-block px-8 py-3.5 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 font-medium hover:bg-gray-800 dark:hover:bg-white transition-colors"
            >
              Explore projects
            </Link>
            <Link
