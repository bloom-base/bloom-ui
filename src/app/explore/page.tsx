    ...
    return (
      <div className="min-h-screen">
        <div className="max-w-5xl mx-auto px-6 py-16">
          <div className="mb-12">
            <div className="h-9 w-56 bg-gray-100 rounded-lg animate-pulse mb-3" />
        ...
        {projects.length > 0 && (
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-1.5 text-sm border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent w-full sm:w-56"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-1.5 text-sm border border-gray-200 rounded-lg bg-white text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent sm:ml-auto"
          >
        ...
        {filteredProjects.length === 0 ? (
          <div className="text-center py-16 border border-dashed border-gray-200 rounded-xl">
            {projects.length === 0 ? (
              ...
              <>
                <p className="text-gray-500">No projects match &ldquo;{search}&rdquo;</p>
                <button
                  onClick={() => setSearch('')}
              ...
              <>
                <p className="text-gray-500">No {filter === 'active' ? 'active' : 'idle'} projects{search.trim() ? ` matching "${search}"` : ''}</p>
                <button
                  onClick={() => setFilter('all')}
                  className="text-sm text-gray-400 hover:text-gray-600 mt-2 underline underline-offset-2"
                >
