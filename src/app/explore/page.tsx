      ...
      <div className="min-h-screen">
        <div className="max-w-5xl mx-auto px-6 py-16 text-center">
          ...
          <button
            ...
            className="mt-4 text-sm px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
            Try again
          </button>
        </div>
        ...
        {projects.length > 0 && (
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent w-full sm:w-56"
            />
          </div>
          <div className="flex items-center gap-1 p-1 bg-gray-100 dark:bg-gray-800 rounded-lg w-fit" role="group" aria-label="Filter projects by activity">
            <button
              ...
              className={`px-3 py-1.5 text-sm rounded-md transition-colors ${
                filter === 'all'
                  ? 'bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-medium shadow-sm'
          ...
          <select
            ...
            className="px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent sm:ml-auto"
          >
