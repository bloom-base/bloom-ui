      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        {projects.length > 0 && (
          ...
          <div className="flex items-center gap-1 p-1 bg-gray-100 dark:bg-gray-800 rounded-lg w-fit" role="group" aria-label="Filter projects by activity">
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full bg-gray-300 dark:bg-gray-500" aria-hidden="true" />
              Idle ({idleCount})
            </button>
          </div>
          <select
            ...
            className="px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent sm:ml-auto"
          >
