    ...
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {/* Free tier */}
          <div className="rounded-xl border border-gray-200 p-6 sm:p-8 flex flex-col">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">Explore projects and contribute ideas.</p>
            </div>
            ...
            {user ? (
              <Link
                href="/explore"
                className="w-full py-3 px-4 rounded-lg border border-gray-200 text-gray-700 text-sm font-medium hover:border-gray-300 transition-colors text-center block"
              >
                Explore projects
              </Link>
            ) : (
          ...
          {/* Pro tier */}
          <div className="relative rounded-xl border border-gray-900 shadow-lg p-6 sm:p-8 flex flex-col">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">Create your own AI-powered projects.</p>
            </div>
            ...
            {isPro ? (
              <div className="w-full py-3 px-4 rounded-lg bg-gray-100 text-gray-500 text-sm font-medium text-center">
                Current plan
              </div>
            ) : (
              <button
          ...
          <div className="rounded-xl border border-gray-200 p-6 sm:p-8 flex flex-col">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">For teams and organizations.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Bring Your Own Key</h3>
                  <span className="px-2 py-0.5 rounded-md text-xs font-medium bg-gray-200 text-gray-600">Any tier</span>
                </div>
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                  Add your Anthropic API key in your{' '}
                  <Link href="/profile" className="text-gray-900 underline underline-offset-2 hover:text-gray-600">profile settings</Link>.
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Sponsorships</h3>
                </div>
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  <div className="p-3 rounded-lg border border-gray-100 bg-gray-50">
                    <div className="text-sm font-medium text-gray-900">Supporter</div>
                    <div className="text-xs text-gray-500 mt-0.5">$25/mo &mdash; priority ideas</div>
                  </div>
                  <div className="p-3 rounded-lg border border-gray-100 bg-gray-50">
                    <div className="text-sm font-medium text-gray-900">Backer</div>
                    <div className="text-xs text-gray-500 mt-0.5">$50/mo &mdash; vision alignment</div>
                  </div>
                  <div className="p-3 rounded-lg border border-gray-100 bg-gray-50">
                    <div className="text-sm font-medium text-gray-900">Patron</div>
                    <div className="text-xs text-gray-500 mt-0.5">$100/mo &mdash; governance votes</div>
                  </div>
                </div>
                    ...
                    {['free', 'pro', 'enterprise'].map((tier) => {
                      ...
                      return (
                        <td key={tier} className="py-3 px-4 text-center">
                          {typeof val === 'boolean' ? (
                            val ? (
                              <svg className="w-4 h-4 text-gray-900 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                              </svg>
                            ) : (
                            ...
                            <span className={`font-mono text-xs ${tier === 'pro' ? 'text-gray-900 font-medium' : 'text-gray-600'}`}>{val}</span>
                          )}
                        </td>
                      )
                    })}
        ...
        <div className="max-w-2xl mx-auto mt-20">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What can I do for free?</h3>
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What does Pro unlock?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What is BYOK?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">How do sponsorships work?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What are agent turns?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">What happens when I hit my compute budget?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">Do I need a GitHub account?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-gray-900 mb-1">How do I get support?</h3>
              <p className="text-sm text-gray-500 leading-relaxed">
