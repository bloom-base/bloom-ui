        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 flex flex-col">
            ...
            {user ? (
              <Link
                href="/explore"
                className="w-full py-3 px-4 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-center block"
              >
                Explore projects
              </Link>
            ) : (
          ...
          {/* Pro tier */}
          <div className="relative rounded-xl border border-gray-900 dark:border-gray-300 shadow-lg p-6 sm:p-8 flex flex-col">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900">
                Most popular
              </span>
            </div>
            ...
            {isPro ? (
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-lg bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium hover:bg-gray-800 dark:hover:bg-white transition-colors disabled:opacity-50"
              >
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="px-2 py-0.5 rounded-md text-xs font-medium bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400">Any tier</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  Add your Anthropic API key in your{' '}
                  <Link href="/profile" className="text-gray-900 dark:text-gray-100 underline underline-offset-2 hover:text-gray-600 dark:hover:text-gray-300">profile settings</Link>.
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {[
                  ...
                  <tr key={row.feature} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
