    ...
    <div className="min-h-screen">
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {/* Free tier */}
          <div className="rounded-xl border border-line p-6 sm:p-8 flex flex-col">
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-ink mb-2">Free</h3>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-semibold text-ink">$0</span>
                <span className="text-ink-secondary">forever</span>
              </div>
              <p className="text-sm text-ink-secondary mt-2">Explore projects and contribute ideas.</p>
            </div>
            ...
            <ul className="space-y-3 mb-8 flex-1">
              {[
                ...
                <li key={feature} className="flex items-start gap-2 text-sm text-ink-secondary">
                  <svg className="w-4 h-4 text-ink-tertiary mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user ? (
              <Link
                href="/explore"
                className="w-full py-3 px-4 rounded-lg border border-line text-ink-secondary text-sm font-medium hover:border-line hover:bg-canvas-subtle transition-colors text-center block"
              >
                Explore projects
              </Link>
            ) : (
          ...
          {/* Pro tier */}
          <div className="relative rounded-xl border border-ink shadow-lg p-6 sm:p-8 flex flex-col">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <span className="px-3 py-1 rounded-full text-xs font-medium bg-ink text-canvas">
                Most popular
              </span>
            </div>

            <div className="mb-6">
              <h3 className="text-lg font-semibold text-ink mb-2">Pro</h3>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-semibold text-ink">$19</span>
                <span className="text-ink-secondary">/mo</span>
              </div>
              <p className="text-sm text-ink-secondary mt-2">Create your own AI-powered projects.</p>
            </div>
            ...
            {isPro ? (
              <div className="w-full py-3 px-4 rounded-lg bg-canvas-subtle text-ink-secondary text-sm font-medium text-center">
                Current plan
              </div>
            ) : (
              <button
                ...
                className="w-full py-3 px-4 rounded-lg bg-ink text-canvas text-sm font-medium hover:bg-ink/90 transition-colors disabled:opacity-50"
              >
          ...
          <div className="rounded-xl border border-line p-6 sm:p-8 flex flex-col">
            <div className="mb-6">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-semibold text-ink">Custom</span>
              </div>
              <p className="text-sm text-ink-secondary mt-2">For teams and organizations.</p>
            </div>
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-ink flex items-center justify-center">
                    <svg className="w-4 h-4 text-canvas" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold text-ink">Bring Your Own Key</h3>
                  <span className="px-2 py-0.5 rounded-md text-xs font-medium bg-canvas-muted text-ink-secondary">Any tier</span>
                </div>
                <p className="text-sm text-ink-secondary leading-relaxed mb-4">
                  Add your Anthropic API key in your{' '}
                  <Link href="/profile" className="text-ink underline underline-offset-2 hover:text-ink-secondary">profile settings</Link>.
                  Your tasks get priority queue placement and agents use your key directly &mdash; no markup, full control.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center gap-2 text-sm text-ink-secondary">
                    <svg className="w-4 h-4 text-ink-tertiary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-ink">Sponsorships</h3>
                </div>
                <p className="text-sm text-ink-secondary leading-relaxed mb-4">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  <div className="p-3 rounded-lg border border-line-subtle bg-canvas-subtle">
                    <div className="text-sm font-medium text-ink">Supporter</div>
                    <div className="text-xs text-ink-secondary mt-0.5">$25/mo &mdash; priority ideas</div>
                  </div>
                  <div className="p-3 rounded-lg border border-line-subtle bg-canvas-subtle">
                    <div className="text-sm font-medium text-ink">Backer</div>
                    <div className="text-xs text-ink-secondary mt-0.5">$50/mo &mdash; vision alignment</div>
                  </div>
                  <div className="p-3 rounded-lg border border-line-subtle bg-canvas-subtle">
                    <div className="text-sm font-medium text-ink">Patron</div>
                    <div className="text-xs text-ink-secondary mt-0.5">$100/mo &mdash; governance votes</div>
                  </div>
                </div>
        ...
        <div className="max-w-3xl mx-auto mt-16">
          <h2 className="text-xl font-semibold text-ink text-center mb-8">
            Compare plans
          </h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-canvas-subtle border-b border-line">
                  <th className="text-left py-3 px-4 font-medium text-ink-secondary">Feature</th>
                  <th className="text-center py-3 px-4 font-medium text-ink-secondary">Free</th>
                  <th className="text-center py-3 px-4 font-medium text-ink">Pro</th>
                  <th className="text-center py-3 px-4 font-medium text-ink-secondary">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-line-subtle">
                {[
                  ...
                  <tr key={row.feature} className="hover:bg-canvas-subtle transition-colors">
                    <td className="py-3 px-4 text-ink-secondary">{row.feature}</td>
                    {['free', 'pro', 'enterprise'].map((tier) => {
                      ...
                      return (
                        <td key={tier} className="py-3 px-4 text-center">
                          {typeof val === 'boolean' ? (
                            val ? (
                              <svg className="w-4 h-4 text-ink mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                              </svg>
                            ) : (
                              <span className="text-ink-tertiary">&mdash;</span>
                            )
                          ) : (
                            <span className={`font-mono text-xs ${tier === 'pro' ? 'text-ink font-medium' : 'text-ink-secondary'}`}>{val}</span>
                          )}
                        </td>
                      )
                    })}
        ...
        <div className="max-w-2xl mx-auto mt-20">
          <h2 className="text-xl font-semibold text-ink text-center mb-10">
            Questions
          </h2>
          <div className="space-y-6">
            <div>
              <h3 className="font-medium text-ink mb-1">What can I do for free?</h3>
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">What does Pro unlock?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">What is BYOK?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">How do sponsorships work?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">What are agent turns?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">What happens when I hit my compute budget?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">Do I need a GitHub account?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <div>
              <h3 className="font-medium text-ink mb-1">How do I get support?</h3>
              <p className="text-sm text-ink-secondary leading-relaxed">
